...
* `DrawCalls` shows the amount of calls telling to draw ... 
...
There is a total of- HOW MANY??? HOLY FUCK
...
Ugh. This was a bit boring to fill.
...
VProf Counters window contains the numbers. Of what? I don't know. There are just a lot of numbers. What are they, calls? amounts? kilograms? The table just says "value". Well, those are values for a fact.

![VProf Counters](images/prof_vcount.png)

The manu has the total amount of- OH HELL NAH ☠︎
