...
The manu has the total amount of- OH HELL NAH 
* `CCvar::FindCommandBase` ...
* `TexGroup_global_Dynamic Verts` ...
* `TexGroup_global_RenderTargets` ...
* `TexGroup_frame_RenderTargets` ...
* `TexGroup_global_DepthBuffer` ...
* `TexGroup_frame_DepthBuffer` ...
* `TexGroup_global_Constant Buffer` ...
* `TexGroup_frame_Constant Buffer` ...
* `Update Constant Buffer` ...
* `TexGroup_frame_Constant Buffers GPU Upload` ...
* `TexGroup_global_Other Verts` ...
* `TexGroup_frame_Other Verts` ...
* `TexGroup_global_Dynamic Indices` ...
* `TexGroup_global_Other Textures` ...
* `TexGroup_frame_Other Textures` ...
* `TexGroup_global_CubeMap textures` Cubemaps global (size? calls? kgs?)
* `TexGroup_frame_CubeMap textures` Cubemaps per-frame (again, of what?)
* `reacquire_resources` ...
* `TexGroup_global_Lightmaps` ...
* `TexGroup_frame_Lightmaps` ...
* `TexGroup_global_Structured Buffers` ...
* `TexGroup_global_RW Structured Buffers` ...
* `vertex shader change` ...
* `pixel shader change` ...
* `DrawIndexedPrimitive` ...
* `numPrimitives` ...
* `Draw Calls` shows the amount of GPU drawing calls per frame
* `TexGroup_global_Storage Textures` ...
* `TexGroup_frame_Storage Textures` ...
* `TexGroup_global_VGUI textures` ...
* `TexGroup_frame_VGUI textures` ...
* `TexGroup_global_Decal textures` ...
* `TexGroup_frame_Decal textures` ...
* `ticks` ... (always 2-4)
* `TexGroup_global_Unaccounted textures` ...
* `TexGroup_frame_Unaccounted textures` ...
* `compute shader change` ...
* `TexGroup_global_World textures` ...
* `TexGroup_frame_World textures` ...
* `TexGroup_global_StaticProp textures` ...
* `TexGroup_frame_StaticProp textures` ...
* `TexGroup_global_Model verts` ...
* `TexGroup_frame_Model verts` ...
* `TexGroup_global_Static Indices` ...
* `TexGroup_global_Model textures` ...
* `TexGroup_frame_Model textures` ...
* `Server SelectWeightedSequence` ...
* `TexGroup_global_Precached` ...
* `TexGroup_frame_Precached` ...
* `TexGroup_global_SkyBox textures` ...
* `TexGroup_frame_SkyBox textures` ...
* `TexGroup_global_World verts` ...
* `TexGroup_frame_World verts` ...
* `TexGroup_global_Particle textures` ...
* `TexGroup_frame_Particle textures` ...
* `TraceRay` ...
* `Client SelectWeightedSequence` ...
* `Peak edict change offsets` ...
* `Edict changes` ...
* `ComputeStaticLightingForCacheEntry` ...
* `TexGroup_global_Lighting Verts` ...
* `TexGroup_frame_Lighting Verts` ...
* `VisCache misses` ...
* `push build view` ...
* `max build view` ...
* `BuildWorldLists` ...
...
* `TexGroup_frame_Structured Buffers GPU Upload` ...
* `TexGroup_frame_Structured Buffers` ...
* `TexGroup_frame_RW Structured Buffers` ...
* `RenderWorld` ...
...
* `TexGroup_global_ClientEffect textures` ...
* `TexGroup_frame_ClientEffect textures` ...
* `PORTAL GUN` ...
