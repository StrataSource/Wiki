...
> [!WARNING]
> Meta level keys are unique to P2:CE's menu implementation. Changing the UI scripts will lose what these keys provide, unless they are reimplemented. See P2:CE's [Panorama code](https://github.com/StrataSource/p2ce-panorama-ui) to see how these meta keys are implemented, and see the [Technical Details](/modding/p2ce-campaigns/advanced/technical-notes) page for more information.

Meta keys are additional properties that change the design and branding of the interface for your campaign.
