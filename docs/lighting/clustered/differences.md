...
* Middle: Clustered Light Inspector with selected light's properties twicked
* Botom: Clustered Light Inspector with selected light's position edited using XYZ bars
